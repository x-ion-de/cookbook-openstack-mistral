...
issues_url       'https://github.com/x-ion-de/cookbook-openstack-workflow/issues'
source_url       'https://github.com/x-ion-de/cookbook-openstack-workflow.git'
